...
@router.put("/log")
def update_log_level(file_name: str = Query(..., description="The name of the file/module"), 
                     level: str = Query(..., description="The log level to set")):
    """
    ...
    file_logger = logging.getLogger(f"app.routers.{file_name}")
